 ...
 */
final class Version20200707123116 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ride CHANGE return_hour return_hour TIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE spot CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD slug VARCHAR(255) NOT NULL, CHANGE phone phone VARCHAR(50) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE token token VARCHAR(50) DEFAULT NULL, CHANGE activation_token activation_token VARCHAR(50) DEFAULT NULL');
